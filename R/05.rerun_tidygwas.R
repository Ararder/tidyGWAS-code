...
raw_path <- fs::dir_ls("/cfs/klemming/projects/supr/ki-pgi-storage/Data/sumstats/wave2/", recurse = TRUE, glob = "*/raw/*")
...
rerun_tidygwas <- function(param_df) {
    ...
    output_dir <- path("/cfs/klemming/projects/supr/ki-pgi-storage/Data/sumstats/wave3", param_df$name)
